              ...
              <View className="min-w-[700px]">
                <View className="flex-row border-b border-border pb-2 mb-1">
                  {['Source #', 'Source Name', 'Target Name', 'Score', 'Source Type', 'Target Type'].map(
                    (label, i) => {
                      const w = i === 0 ? 'w-[80px]' : i === 3 ? 'w-[60px]' : i >= 4 ? 'w-[100px]' : 'flex-1';
                ...
                {tableRows.map((row, idx) => (
                  ...
                  >
                    <Text className="w-[80px] font-mono text-xs text-foreground">{row.sourceNumber}</Text>
                    ...
                    <Text className="w-[100px] text-xs text-muted-foreground" numberOfLines={1}>{row.sourceType}</Text>
                    <Text className="w-[100px] text-xs text-muted-foreground" numberOfLines={1}>{row.targetType}</Text>
                  </View>
                ))}
              </View>
            </ScrollView>
